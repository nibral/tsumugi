...
const searchProgramFromTimetable = (timetable, time) => {
    let nowProgram = null;
    while (!nowProgram) {
        // 曜日と開始時刻が一致する番組を検索
...
/*
    番組表から現在放送中の番組の情報を取得
*/
module.exports.getNowProgramFromTimetable = (timetable) => {
    return new Promise((resolve, reject) => {
        ...
        // 放送中の番組を探す
        const nowProgram = searchProgramFromTimetable(timetable, startTime);
